...
# INFO
print(data)
print(f'Zależność liniowa(powinna być równa ilości kolumn): {np.linalg.matrix_rank(data)}')
...
# Wyniki
# print (f'Features Ranking {sortedFeatures}', file=open('result.txt', 'w'))
...
#     print(f'Stats 20-NN: \n\t Accuracy: {accuracy} \n\t Precision: {precision} \n\t Recall: {recall} \n\t Fscore: {fscore} \n\t Confusion Matrix: \n {confusionMatrix}', file=open('result.txt', 'a'))
#     print(f'------------------', file=open('result.txt', 'a'))